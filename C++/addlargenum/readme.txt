...
To use the program:
	- compile: g++ -ansi -pedantic -Wall addlargenum.cxx list.cxx stack.cxx -o addlargenum
	- ./addlargenum <name_of_txt_file.txt> name_of_output_file.txt

Notes for graders:
	- although successfully implemented list and stack, unable to get addlargenum to 		work properly, encountered segmentation fault even after multiple attempts
